  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'glassmorphism': 'var(--glassmorphism-gradient)',
      },
      boxShadow: {
        ...
        'strong': '0 10px 40px -4px rgba(0, 0, 0, 0.15), 0 4px 25px -5px rgba(0, 0, 0, 0.1)',
      ...
      keyframes: {
        ...
        "glow": {
          ...
          to: { filter: "drop-shadow(0 0 30px hsl(var(--primary-glow) / 0.6))" },
        },
        "shimmer": {
